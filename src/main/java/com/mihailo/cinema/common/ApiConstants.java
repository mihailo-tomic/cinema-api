...
public class ApiConstants {
    ...
    public static class Movie {
        ...
        public static final String SEARCH_TITLE_PATH = BASE_PATH + SEARCH + SEARCH_TITLE + "?" + PARAM_TITLE + "={title}";
        public static final String REL_TITLE = "titleSearch";

        public static final String SEARCH_UPCOMING = "/upcoming";
        public static final String SEARCH_UPCOMING_PATH = BASE_PATH + SEARCH + SEARCH_UPCOMING + "?" + PARAM_DATE + "={date}";
        public static final String REL_UPCOMING = "upcomingSearch";

        public static final String SEARCH_UPCOMING_RANGE = "/upcomingRange";
        public static final String SEARCH_UPCOMING_RANGE_PATH = BASE_PATH + SEARCH + SEARCH_UPCOMING_RANGE + "?" + PARAM_DATE_FROM + "={from}&" + PARAM_DATE_TO + "={to}";
